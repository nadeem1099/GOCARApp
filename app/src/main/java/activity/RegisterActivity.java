...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !nationality.isEmpty() && !age.isEmpty() && !number.isEmpty()) {
                    registerUser(name, email, password, nationality, age, number);
                } else {
    ...
    private void registerUser( final String name, final String email,
                              final String password, final String nationality, final String age, final String number) {
